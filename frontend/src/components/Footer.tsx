...
const SOCIALS = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61583210546182',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/_praveen.pilla/',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/praveen-pilla-273086383',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/Praveen360-code',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <footer className="site-footer" id="contact">
      ...
      <div className="container footer-grid">
        ...
        <div className="footer-quicklinks-col">
          ...
          <div className="footer-nav-sub">
            {NAV_ITEMS.map((item) => (
              <button key={item.targetId} onClick={() => scrollTo(item.targetId)}>
